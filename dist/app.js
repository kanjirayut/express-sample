...
// Import dependencies
const express_1 = __importDefault(require("express")); // Express framework for handling HTTP requests
...
const routes_1 = __importDefault(require("./routes")); // Correct path based on your folder structure
...
app.use("/api/v1", routes_1.default); // Use main router under `/api/v1`
